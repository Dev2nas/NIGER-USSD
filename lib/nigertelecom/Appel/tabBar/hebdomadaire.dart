...
_500f() async {
  const number = '*141*1*3*1#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_1000f() async {
  const number = '*141*1*3*2#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_1500f() async {
  const number = '*141*1*3*3#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_3000f() async {
  const number = '*141*1*3*4#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
