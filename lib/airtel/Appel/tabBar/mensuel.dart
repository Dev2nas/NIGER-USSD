                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "1000Min vers Airtel+SMS illimité",
                          style: GoogleFonts.lato(
                            fontSize: 20,
                            fontWeight: FontWeight.w800,
                          ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "Appel illimité vers Airtel+SMS illimité+300minTR+12GO",
                          style: GoogleFonts.lato(
                            fontSize: 20,
                            fontWeight: FontWeight.w800,
                          ),
...
_5000f() async {
  const number = '*141*1*4*1#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_10000f() async {
  const number = '*141*1*4*2#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_20000f() async {
  const number = '*141*1*4*3#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
