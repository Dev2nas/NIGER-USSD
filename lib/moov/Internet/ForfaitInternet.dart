...
import 'package:niger_ussd/moov/internet/tabBar/hebdomadaire.dart';
import 'package:niger_ussd/moov/internet/tabBar/nuit.dart';
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TabBar(isScrollable: true,
                    labelColor: HexColor('#0071bc'),
                    //indicatorColor: Colors.white,
                    unselectedLabelColor: HexColor('#f38326'),
                    //indicator: BoxDecoration(color: HexColor('#f38326'),),
                    indicatorColor: HexColor('#0071bc'),
                    tabs: [
