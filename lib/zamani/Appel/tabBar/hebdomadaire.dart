                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "100 Min+100SMS vers Zamani+75Min TR",
                          style: GoogleFonts.lato(
                            fontSize: 20,
                            fontWeight: FontWeight.w800,
                          ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "250 Min+200 SMS vers Zamani+200Min TR",
                          style: GoogleFonts.lato(
                            fontSize: 20,
                            fontWeight: FontWeight.w800,
                          ),
...
__500f() async {
  const number = '#225*2*2*7#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_1000f() async {
  const number = '#225*2*2*8#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_1500f() async {
  const number = '#225*2*1*4#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
