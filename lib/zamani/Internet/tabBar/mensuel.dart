...
_2000f() async {
  const number = '#225*4*3*1#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_5000f() async {
  const number = '#225*4*3*2#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_10000f() async {
  const number = '#225*4*3*3#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_20000f() async {
  const number = '#225*4*3*4#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_50000f() async {
  const number = '#225*4*3*5#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
