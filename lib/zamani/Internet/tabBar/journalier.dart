...
_100f() async {
  const number = '#225*4*1*1#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_150f() async {
  const number = '#225*4*1*2#'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}
_200f() async {
  const number = '#225*4*1*3'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_300f() async {
  const number = '#225*4*1*4'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}

_500f() async {
  const number = '#225*4*1*5'; //set the number here
  bool? res = await FlutterPhoneDirectCaller.callNumber(number);
}